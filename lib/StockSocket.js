...
var root = protobufjs_1.default.loadSync(__dirname + "/PricingData.proto");
var Ticker = root.lookupType("ticker");
...
function startDataFeed(callback) {
    ...
    ws.onmessage = function incoming(data) {
        var decodedData = Ticker.decode(Buffer.from(data.data, "base64")).toJSON();
