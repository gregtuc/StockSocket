...
const root = protobufjs_1.default.loadSync(__dirname + "/PricingData.proto");
const Ticker = root.lookupType("ticker");
var ws = new isomorphic_ws_1.default("wss://streamer.finance.yahoo.com");
var tickersArray = [];
/**
...
function startDataFeed(callback) {
    if (ws.readyState == 1) {
        ws.send("close");
        ws = new isomorphic_ws_1.default("wss://streamer.finance.yahoo.com");
    }
